...
CONFIG_PATH="${4:-${CMKAN_CONFIG_PATH:-configs/custom_unpaired_reference_v8_environment.server.yaml}}"
FACE_MASK_ROOT="${5:-${CMKAN_FACE_MASK_ROOT:-/home/share/y50063074/data_face_masks}}"
